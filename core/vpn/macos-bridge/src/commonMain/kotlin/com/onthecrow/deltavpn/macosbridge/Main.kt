package com.onthecrow.deltavpn.macosbridge

import com.onthecrow.deltavpn.vpn.AppleTunnelManager
...
private fun xrayErrorLogPath(): String? {
    ...
    val container = NSFileManager.defaultManager
        .containerURLForSecurityApplicationGroupIdentifier("group.com.onthecrow.deltavpn")
    return null
}
...
// Child of the desktop app bundle id (desktopApp packageName = "com.onthecrow.deltavpn"), as the
...
private const val DEFAULT_SYSEXT_ID = "com.onthecrow.deltavpn.SystemExtension"
