...
import com.onthecrow.deltavpn.analytics.QsBlockedReason
import com.onthecrow.deltavpn.analytics.QsTileAction
...
import com.onthecrow.deltavpn.vpn.impl.R as VpnImplR
...
class VpnTileService : TileService(), KoinComponent {
    ...
    private fun render(status: ConnectionStatus, configName: String?) {
        ...
        // The mark lives in core:vpn:impl next to the notification that shares it. Non-transitive R
        // classes mean the library's drawables are not in this module's R, hence the alias import.
        tile.icon = Icon.createWithResource(this, VpnImplR.drawable.ic_app_mono)
