; Inno Setup script for DeltaVPN (Windows).
...
;   2) ISCC.exe /DAppDir="<...>\build\compose\binaries\main\app\DeltaVPN" \
...
#ifndef AppDir
  #define AppDir "..\..\desktopApp\build\compose\binaries\main\app\DeltaVPN"
#endif
#ifndef OutDir
  #define OutDir "..\..\desktopApp\build\installer"
#endif
#define MyAppName "DeltaVPN"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Onthecrow"
#define MyAppExe "DeltaVPN.exe"
